...
public class UserServiceImpl implements UserService {
	...
	public int insUserService(TbUsers user) throws Exception {
		...
		return tbUsersMapper.insert(user);
	}
	...
	public ResultUtil selUsers(Integer page, Integer limit,UserSearch search) {
		...
		if(search.getType() !=0){
			...
			criteria.andTypdEqualTo(search.getType());
		}
	...
	@Override
	public TbUsers getphone(String phone) {
		// TODO Auto-generated method stub
		return tbUsersMapper.getphone(phone);
	}

	@Override
	public TbUsers getnickname(String nickname) {
		// TODO Auto-generated method stub
		return tbUsersMapper.getnickname(nickname);
	}

	@Override
	public TbUsers getinfo(String phone, String password) {
		// TODO Auto-generated method stub
		return tbUsersMapper.getinfo(phone, password);
	}

	@Override
	public int updatepassword(String password, Long uid) {
		int rel=tbUsersMapper.updatepassword(password, uid);
		return rel;
	}
