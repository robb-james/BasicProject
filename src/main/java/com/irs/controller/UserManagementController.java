...
public class UserManagementController {
	...
	@RequestMapping("ordinaryuserList")
	@RequiresPermissions("user:user:list")
	public String ordinary() {
		return "page/user/ordinaryUserList";
	}
	 ...
	 * @return
	 */
	@RequestMapping("getordinaryUserList")
	@RequiresPermissions("user:user:list")
	@ResponseBody
	public ResultUtil getordinaryUserList(Integer page, Integer limit, UserSearch search) {
		search.setType(2);//普通用户
		return userServiceImpl.selUsers(page, limit, search);
	}
