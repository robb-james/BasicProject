				...
				c = {
					...
					image : function(a) {
						...
						layui.use("upload", function(o) {
							var r = l.uploadImage || {};
							var elem = r.multiple ? e(e(n).find("input")[0]).attr("multiple", "multiple") : e(n).find("input")[0];
							var baseUrl = r.url.substring(0, r.url.indexOf("default/"));
							o.render({
								url : r.url,
								method : r.type,
								elem : elem, //e(n).find("input")[0],
								multiple : r.multiple,
								...
								//200 == e.status ? (e.data = e.data || {},v.call(t, "img", {src : baseUrl+e.data.src,alt : e.data.title}, a)) : i.msg(e.msg || "上传失败")
								}
							})
						})
					},
