...
<script type="text/javascript">
		...
		function initTable (sendUser,messageType,is) {
		    ...
		    "aoColumns":[
		        ...
		        { "mDataProp": "hname" },
		        { "mDataProp": function(lineData){
		        	return "<img src='"+lineData.hurl+"' style='width:50px;height:50px''/>";
		        	
		        }
		        },
				{ 
				   "mDataProp": function(lineData){
					   return '<button type="button" onclick="del(\''+lineData.hid+'\',1)" class="btn btn-danger">删除</button><a href="${basepath}/slide/getinfo?hid='+lineData.hid+'" class="btn btn-icon-only yellow" title="编辑"><i  class="fa fa-file-o"></i></a>';
	               	 	}
				    } 
		      //  { "data": "salary" }
		    ]
	...
	/* 禁用事件 */
		...
		function comeadd(){
			location.href="${basepath}/page/slide/slideAdd.jsp"	;	
		}
