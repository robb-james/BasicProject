...
<link rel="stylesheet" href="${ctx }/static/layui/css/layui.css"
	media="all" />
<link rel="stylesheet"
	href="${ctx }/static/css/font_eolqem241z66flxr.css" media="all" />
...
<body class="childrenBody">
		...
		<form class="layui-form">
			...
			<!-- 	<div class="layui-inline">
				...
				<shiro:hasPermission name="user:user:delete">
					<div class="layui-inline">
						<a class="layui-btn layui-btn-danger batchDel">踢出用户</a>
					</div>
				</shiro:hasPermission>
	...
	<script>
		layui.config({base : "static/js/"}).use([ 'form', 'layer', 'jquery', 'table', 'laydate' ],function() {
							var form = layui.form, table = layui.table, layer = parent.layer === undefined ? layui.layer
									...
									active = {
										search : function() {
			var nickname = $('#nickname'), sex = $('#sex option:selected'), status = $('#status option:selected'),createTimeStart = $("#createTimeStart"),createTimeEnd = $("#createTimeEnd");
											//执行重载
							...
							$(".batchDel").click(function() {
												...
												if (data.length > 0) {
													...
													layer.confirm('确定删除<strong>'+ data.length+ '</strong>条数据吗？',
																	function(index) {
																		//调用删除接口
																		$.ajax({url : ctx+ '/sys/kickout/'+ids,//接口地址
																					type : "get",
