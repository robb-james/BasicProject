			...
			<div class="portlet-body form">
				...
				<form id="updateForm" action="#" id="form_sample_3"
					...
					<div class="form-body">
						...
						<input type="hidden" value="${big.bid}" id="bid" name="bid">
						<div class="form-group">
							<label class="control-label col-md-3">名称<span
								class="required"> * </span>
							</label>
							<div class="col-md-4">
								<input type="text" id="bname" name="bname" data-required="1"value="${big.bname}" class="form-control" />
							</div>
						</div>
