...
<script type="text/javascript">
		...
		function initTable (sendUser,messageType,is) {
		 ...
		 /*  "fnDrawCallback": function(){
		    ...
		    "aoColumns":[
				...
				{ 
				   "mDataProp": function(lineData){
					   return '<a onclick="update('+lineData.cid+')" class="btn btn-icon-only yellow" title="编辑"><i  class="fa fa-file-o"></i></a>';
	               	 	}
				    } 
		      //  { "data": "salary" }
		    ]
		...
		function comeadd(){
			location.href="${basepath}/classify/goadd"	;	
		}
	function update(id){
		location.href="${basepath}/classify/getinfo?id="+id;
