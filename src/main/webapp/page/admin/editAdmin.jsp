...
<body class="childrenBody">
	<form class="layui-form" style="width: 80%;">
		<!-- 管理员id -->
		<input type="hidden" name="uid" value="${ad.id }"/>
		<div class="layui-form-item">
			<label class="layui-form-label">昵称</label>
			<div class="layui-input-block">
				<input type="text" id="username" class="layui-input userName"
					lay-verify="required" readonly="readonly" name="nickname" value="${ad.fullname }">
			</div>
		</div>
		<div class="layui-form-item">
	...
	<script type="text/javascript" src="${ctx }/static/js/editAdmin.js"></script>
</body>
</html>