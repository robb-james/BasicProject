...
<body class="childrenBody">
	<form class="layui-form" style="width: 80%;">
		<!-- 管理员id -->
		<input type="hidden" name="id" value="${ad.uid }"/>
		<div class="layui-form-item">
			<label class="layui-form-label">昵称</label>
			<div class="layui-input-block">
				<input type="text" id="username" class="layui-input userName"
					lay-verify="required" readonly="readonly" name="username" value="${ad.nickname }">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="username" class="layui-input userName"
					lay-verify="required" placeholder="请输入姓名" value="${ad.username }">
			</div>
		</div>
		<div class="layui-form-item">
	...
	<script type="text/javascript" src="${ctx }/static/js/personalData.js"></script>
</body>
</html>