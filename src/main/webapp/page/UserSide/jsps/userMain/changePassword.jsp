...
<div class="center_right" id="MemberCenterCtrl" style="display: block;">
	...
	<form id="fro" class="form-horizontal" role="form" action="${ctx}/user/xgmm.html" method="post" style="width: 60%; margin: 0 auto;">
          <div class="control-group">
            <label class="control-label" >原密码</label>
            <div class="controls">
              <input type="password"  class="span3" placeholder="请输入原密码"  name="mima">
            </div>
          </div>
          <div class="control-group">
