...
<body>
	<div class="top">
		<div class="topbar">
			...
			</span> <span class="operate_nav"> <span id="account"
			...
			</span> <span class="operate_nav"> <a rel="nofollow"
				href="${ctx}/user/jumplogin.html">我的订单</a> |
			</span> <span class="operate_nav"> <a href="${ctx}/cart/select.html"
				name="购物车" dd_name="购物车"> <i class="icon_card"></i>购物车<b
					id="cart_items_count"></b>
			</a>
			</span>
		</div>
	</div>
				...
				<div class="think-form"
					...
					<div class="loginform">
						<a rel="nofollow" href="javascript:void(0)" class="img"> <img
							src="images/logo-3.jpg" height="300" width="400">
						</a>
					</div>
						...
						<form name="frm" class="form-horizontal" role="form" method="post">
							...
							<div class="control-group">
								<div class="controls">
									...
									<input type="button" class="btn" id="code" value="获取验证码"
										onclick="codeButton()"><label id="tyzm"
							...
							<div class="control-group">
								<div class="controls">
									<button type="button" class="zhuce" onclick="bdtj()">注
										册</button>
								</div>
